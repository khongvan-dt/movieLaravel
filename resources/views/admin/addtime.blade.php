        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Thêm Lịch Chiếu</h1>
                    <div class="card mb-4">
                        <div class="card-body">
                            <div>
                            ...
                            <form method="post"
                                action="{{ route('addtime', ['rapId' => $time->Id_Rap, 'movieId' => $time->ID_Phim]) }}">
                                @csrf
                                <div class="bd">
                                    <div>
                                        <div class="text">
                                        ...
                                        <input class="form-control" type="date" name='ngayChieu'
                                    ...
                                    <div>
                                        ...
                                        <input class="form-control" type="text " name='strat'
                                            placeholder="Nhập giờ bắt đầu ">
                                    ...
                                    <div>
                                        ...
                                        <input class="form-control" type="text" name='end'
                                            placeholder="Nhập giờ kết thúc ">
