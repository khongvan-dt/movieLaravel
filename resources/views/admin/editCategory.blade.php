...
<head>
    ...
    <title>Sửa Thể Loại Phim</title>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">Sửa Thể Loại Phim</a>
        <!-- Sidebar Toggle-->
            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="{{ route('updateCategory', ['id' => $EditCategory->the_loai_id]) }}"
                                    method="POST">
                                    @csrf
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <th>Tên Thể Loại Phim : <input type="text" name="edit_category"
                                                    value="{{ $EditCategory->tenTheLoai }}"></th>
                                        </tr>
                                        <tr>
                                            <th>
                                                Chức năng : <button class="btn btn-primary" type="submit"
