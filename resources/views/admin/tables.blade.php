                                ...
                                <tbody>
                                    @foreach ($movies as $movie)
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset($movie->img) }}" width="150px" height="100px"></td>
                                            <td>
                                                {{ $movie->Max_time }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {{ number_format($movie->priceMovie) }}
                                            </td>
                                            <td  style="width: 40%;">
                                                {{ $movie->description }}
                                            </td>
                                            <td>
                                                <form method="post"
                                                    action="{{ route('deleteMovies', ['movieId' => $movie->movie_id]) }}">
                                                    @csrf
                                                    {{-- <input type="hidden" name="_method" value="POST"> --}}
                                                    <button type="submit" class="btn btn-primary">Delete</button>
                                                </form>
                                                <a class="btn btn-primary"
                                                    href="{{ route('editMovie', ['movieId' => $movie->movie_id]) }}">Sửa</a>
